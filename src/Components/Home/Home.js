      ...
      <div className="AboutPage">
        <div className="AboutText">
          ...
          <p>
            ...
            <br />
            <br />I am fluent in <b>C#, Java, JavaScript</b> and know a bit of{" "}
            <b>Python</b> and am working on a few projects in the <b>Full</b>{" "}
            stack.
            <br />I plan to learn <b>Next.js</b>, <b>Three.js</b> and
            <b> Typescript</b> in the near future. <br />
            <br />
            Also, I love <b>Chai Latte</b>{" "}
